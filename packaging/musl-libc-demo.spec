...
%description
Three C probe variants built inside one Tizen GBS chroot with the platform
clang: glibc dynamic, musl static, and musl dynamic with a package-private
loader. The package is isolated below /opt/usr/musl-demo.
